...
map <Leader>vv    :call g:RubyDebugger.open_variables()<CR>
map <Leader>pp    :call g:RubyDebugger.open_breakpoints()<CR>
map <Leader>fr    :call g:RubyDebugger.open_frames()<CR>
...
map <Leader>db    :call g:RubyDebugger.remove_breakpoints()<CR>
