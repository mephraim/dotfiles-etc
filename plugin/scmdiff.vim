...
function! s:SCMDiff(...)
  ...
  highlight DiffAdd guibg=#252B29 ctermbg=black ctermfg=DarkGreen
  highlight DiffChange guibg=#252B29 ctermbg=black ctermfg=DarkGreen
  highlight DiffText guibg=#252B29 ctermbg=black ctermfg=DarkGreen cterm=underline
